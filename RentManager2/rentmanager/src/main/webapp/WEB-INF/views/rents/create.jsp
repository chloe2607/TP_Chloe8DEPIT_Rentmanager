                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control" id="car" name="car">
                                            <c:forEach items="${vehicle}" var="vv">
                                            <option value=${vv.id}>${vv.id} ${vv.constructeur}</option>
                                             </c:forEach>
                                            </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <c:forEach items="${client}" var="cc">
                                            <option value=${cc.identifiant}>${cc.prenom} ${cc.nom}</option>
                                             </c:forEach>
                                        </select>
                                    </div>
                                </div>
